...
queries = [
    ...
    "SELECT region, COUNT(*) AS teacher_count FROM teachers_partitioned_by_region GROUP BY region;",
    ...
    "SELECT candidate_name, candidate_surname, candidate_lastname, desired_region, phone_number FROM candidates WHERE selection_passed IS FALSE;"
]
...
def execute_query(query, num_attempts):
    ...
    for _ in range(num_attempts):
        ...
        for row in rows:
            ...
            costs = cost_pattern.findall(row_str)
